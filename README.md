# Daily Problem from Daily Interview Pro
...
- [Partition a list](doc/partition-a-list.md)
- [Picking up change](doc/picking-up-change.md)
- [Determine if number](doc/determine-if-number.md)
- [Making change](doc/making-change.md)
- [Phone numbers](doc/phone-numbers.md)
- [Rotate array](doc/rotate-array.md)